...
<?php script_tag('assets/purecounter/purecounter_vanilla.js'); ?>
<?php script_tag('assets/bootstrap/js/bootstrap.bundle.min.js'); ?>
<?php script_tag('assets/glightbox/js/glightbox.min.js'); ?>
<?php script_tag('assets/isotope-layout/isotope.pkgd.min.js'); ?>
<?php script_tag('assets/swiper/swiper-bundle.min.js'); ?>
<?php script_tag('assets/waypoints/noframework.waypoints.js'); ?>
<?php script_tag('assets/php-email-form/validate.js'); ?>
