...
class Guests extends BaseController
{
  ...
  public function create()
  {
    ...
    if (!$this->request->is('post')) {
      ...
      return view('templates/header', ['title' => 'Add a user'])
        . view('guests/create')
        . view('templates/footer');
    }
    ...
    if (!$this->validateData($post, [
      'name' => 'required|max_length[70]|min_length[2]',
      'email' => 'required|valid_email|max_length[50]|min_length[5]',
      'website' => 'valid_url_strict|max_length[100]|min_length[3]',
      'comment'  => 'max_length[5000]|min_length[0]',
